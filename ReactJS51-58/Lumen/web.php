...
$router->get('api/order/{a}/{b}' , ['uses' => 'OrderController@show']);
$router->get('api/detail/{a}/{b}' , ['uses' => 'DetailController@show']);

//update
$router->post('api/menu/{id}' , ['uses' => 'MenuController@update']);
$router->put('api/order/{id}' , ['uses' => 'OrderController@update']);
$router->put('api/user/{id}' , ['uses' => 'LoginController@update']);
